...
export default function Edit({ animal }: { animal: Animal }) {
            ...
            header={
                <div className="flex items-center justify-between gap-3">
                    <div>
                        ...
                        <h2 className="text-2xl font-bold text-slate-900">Edit Hewan</h2>
                    </div>
                    <Link
            ...
            <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
                <form onSubmit={submit} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
                    <div className="mb-6 flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-slate-900">Perbarui data ternak</h3>
                            <p className="text-sm text-slate-500">Ubah informasi utama hewan berdasarkan kebutuhan.</p>
                        </div>
                    </div>
